/**
 * UberEats Style Icons
 * SVG-Icons im UberEats-Design
 */
...
export function OrdersIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavigationIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StatsIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RestaurantIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M7 2v20" />
      <path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3a2 2 0 0 0 2-2v0" />
      <path d="M21 15v7" />
    </svg>
  );
}
...
export function CarIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M14 16H9m10 0h3v-3.49a2 2 0 0 0-1.94-1.95L15 12.49a2 2 0 0 1-1.94-1.95V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v3.49a2 2 0 0 1-1.94 1.95L1 12.49A2 2 0 0 0 0 14.49V19h3" />
...
export function AlertCircleIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrendingDownIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LightbulbIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 3a6 6 0 0 0 6 6c0 2.5-2 4.5-2 4.5H8s-2-2-2-4.5a6 6 0 0 0 6-6z" />
    </svg>
  );
}
...
export function BatteryIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WifiOffIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M1.42 9a16 16 0 0 1 4.7-4.7" />
      <path d="M8.53 16.11a6 6 0 0 1 6.95 0" />
      <line x1="12" y1="20" x2="12.01" y2="20" />
    </svg>
  );
...
export function VolumeXIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DollarSignIcon({ size = 24, color = 'currentColor', className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}

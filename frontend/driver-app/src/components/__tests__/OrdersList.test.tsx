...
const mockOrders: Order[] = [
  {
    ...
    totalAmount: 25.50,
    phone: '+49123456789',
    restaurant: { id: 'restaurant-1', name: 'Restaurant 1', address: 'Address 1' },
    customer: { id: 'customer-1', name: 'Customer 1', phone: '+49123456789' },
    address: 'Delivery 1',
  ...
  },
  {
    ...
    totalAmount: 30.00,
    phone: '+49123456790',
    restaurant: { id: 'restaurant-2', name: 'Restaurant 2', address: 'Address 2' },
    customer: { id: 'customer-2', name: 'Customer 2', phone: '+49123456790' },
    address: 'Delivery 2',

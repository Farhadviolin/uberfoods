 ...
 * Modern, scalable design tokens for UberFoods Admin Panel
 */
...
export const designTokens = {
  ...
  colors: {
    ...
    // Secondary Colors (Facebook Purple)
    secondary: {
      50: '#faf5ff',
      100: '#f3e8ff',
      200: '#e9d5ff',
  ...
  typography: {
    fontFamily: {
      ...
      mono: ['JetBrains Mono', 'SFMono-Regular', 'Monaco', 'Inconsolata', 'Roboto Mono', 'Consolas', 'monospace'],
  ...
  // Modern Shadows (professioneller und subtiler)
  shadows: {
    none: 'none',
